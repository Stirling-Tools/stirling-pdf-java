...
import org.openapis.openapi.models.errors.DeletePagesBadRequestException;
import org.openapis.openapi.models.errors.DeletePagesInternalServerError;
import org.openapis.openapi.models.errors.DeletePagesRequestEntityTooLargeException;
import org.openapis.openapi.models.errors.DeletePagesUnprocessableEntityException;
...
public class DeletePages {
    ...
    public static class Sync extends Base
            implements RequestOperation<PDFWithPageNums, DeletePagesResponse> {
        ...
        @Override
        public DeletePagesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeletePagesResponse.Builder resBuilder =
                    DeletePagesResponse
                            .builder()
            ...
            DeletePagesResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    DeletePagesBadRequestException out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "413")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    DeletePagesRequestEntityTooLargeException out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                        out.withRawResponse(response);
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    DeletePagesUnprocessableEntityException out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                        out.withRawResponse(response);
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "500")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    DeletePagesInternalServerError out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                        out.withRawResponse(response);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PDFWithPageNums, org.openapis.openapi.models.operations.async.DeletePagesResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.DeletePagesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.DeletePagesResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.DeletePagesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            org.openapis.openapi.models.operations.async.DeletePagesResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        org.openapis.openapi.models.errors.async.DeletePagesBadRequestException out;
                        try {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "413")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        org.openapis.openapi.models.errors.async.DeletePagesRequestEntityTooLargeException out;
                        try {
                            out = Utils.mapper().readValue(
                                    bodyBytes,
                                    new TypeReference<>() {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        org.openapis.openapi.models.errors.async.DeletePagesUnprocessableEntityException out;
                        try {
                            out = Utils.mapper().readValue(
                                    bodyBytes,
                                    new TypeReference<>() {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "500")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        org.openapis.openapi.models.errors.async.DeletePagesInternalServerError out;
                        try {
                            out = Utils.mapper().readValue(
                                    bodyBytes,
                                    new TypeReference<>() {
