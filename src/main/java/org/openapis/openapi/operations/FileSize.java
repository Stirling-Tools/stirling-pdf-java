...
public class FileSize {
    ...
    public static class Sync extends Base
            implements RequestOperation<FileSizeRequest, FileSizeResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(FileSizeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<FileSizeRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(FileSizeRequest request) throws Exception {
        ...
        @Override
        public FileSizeResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            FileSizeResponse.Builder resBuilder =
                    FileSizeResponse
                            .builder()
            ...
            FileSizeResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<FileSizeRequest, org.openapis.openapi.models.operations.async.FileSizeResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(FileSizeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<FileSizeRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(FileSizeRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.FileSizeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.FileSizeResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.FileSizeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            org.openapis.openapi.models.operations.async.FileSizeResponse res = resBuilder.build();
