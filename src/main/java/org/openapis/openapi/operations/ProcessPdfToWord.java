...
public class ProcessPdfToWord {
    ...
    static abstract class Base {
        ...
        <T, U>HttpRequest buildRequest(T request, TypeReference<U> typeReference) throws Exception {
            ...
            req.addHeader("Accept", "application/msword;q=1, application/vnd.openxmlformats-officedocument.wordprocessingml.document;q=0")
    ...
    public static class Sync extends Base
            implements RequestOperation<PdfToWordRequest, ProcessPdfToWordResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PdfToWordRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<PdfToWordRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PdfToWordRequest request) throws Exception {
        ...
        @Override
        public ProcessPdfToWordResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ProcessPdfToWordResponse.Builder resBuilder =
                    ProcessPdfToWordResponse
                            .builder()
            ...
            ProcessPdfToWordResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PdfToWordRequest, org.openapis.openapi.models.operations.async.ProcessPdfToWordResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PdfToWordRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<PdfToWordRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PdfToWordRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.ProcessPdfToWordResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.ProcessPdfToWordResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.ProcessPdfToWordResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            org.openapis.openapi.models.operations.async.ProcessPdfToWordResponse res = resBuilder.build();
