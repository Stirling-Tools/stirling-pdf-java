...
public class PageRotation {
    ...
    public static class Sync extends Base
            implements RequestOperation<PageRotationRequest, PageRotationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PageRotationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<PageRotationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PageRotationRequest request) throws Exception {
        ...
        @Override
        public PageRotationResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PageRotationResponse.Builder resBuilder =
                    PageRotationResponse
                            .builder()
            ...
            PageRotationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PageRotationRequest, org.openapis.openapi.models.operations.async.PageRotationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PageRotationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<PageRotationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PageRotationRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PageRotationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PageRotationResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PageRotationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            org.openapis.openapi.models.operations.async.PageRotationResponse res = resBuilder.build();
