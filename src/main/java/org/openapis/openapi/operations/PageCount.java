...
public class PageCount {
    ...
    public static class Sync extends Base
            implements RequestOperation<PDFComparisonAndCount, PageCountResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PDFComparisonAndCount request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<PDFComparisonAndCount>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PDFComparisonAndCount request) throws Exception {
        ...
        @Override
        public PageCountResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PageCountResponse.Builder resBuilder =
                    PageCountResponse
                            .builder()
            ...
            PageCountResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PDFComparisonAndCount, org.openapis.openapi.models.operations.async.PageCountResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PDFComparisonAndCount request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<PDFComparisonAndCount>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PDFComparisonAndCount request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PageCountResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PageCountResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PageCountResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            org.openapis.openapi.models.operations.async.PageCountResponse res = resBuilder.build();
