...
public class GetTeamsData {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<GetTeamsDataResponse> {
        ...
        @Override
        public GetTeamsDataResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTeamsDataResponse.Builder resBuilder =
                    GetTeamsDataResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetTeamsDataResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<org.openapis.openapi.models.operations.async.GetTeamsDataResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetTeamsDataResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetTeamsDataResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetTeamsDataResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetTeamsDataResponse res = resBuilder.build();
