...
public class GetLoginData {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<GetLoginDataResponse> {
        ...
        @Override
        public GetLoginDataResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetLoginDataResponse.Builder resBuilder =
            ...
            GetLoginDataResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<org.openapis.openapi.models.operations.async.GetLoginDataResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetLoginDataResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetLoginDataResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetLoginDataResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetLoginDataResponse res = resBuilder.build();
