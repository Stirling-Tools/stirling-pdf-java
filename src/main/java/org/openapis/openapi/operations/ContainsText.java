...
public class ContainsText {
    ...
    public static class Sync extends Base
            implements RequestOperation<ContainsTextRequest, ContainsTextResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ContainsTextRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ContainsTextRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ContainsTextRequest request) throws Exception {
        ...
        @Override
        public ContainsTextResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ContainsTextResponse.Builder resBuilder =
                    ContainsTextResponse
                            .builder()
            ...
            ContainsTextResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ContainsTextRequest, org.openapis.openapi.models.operations.async.ContainsTextResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ContainsTextRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ContainsTextRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ContainsTextRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.ContainsTextResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.ContainsTextResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.ContainsTextResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            org.openapis.openapi.models.operations.async.ContainsTextResponse res = resBuilder.build();
