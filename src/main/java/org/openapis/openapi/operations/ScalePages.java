...
import org.openapis.openapi.models.errors.ScalePagesBadRequestException;
import org.openapis.openapi.models.errors.ScalePagesInternalServerError;
import org.openapis.openapi.models.errors.ScalePagesRequestEntityTooLargeException;
import org.openapis.openapi.models.errors.ScalePagesUnprocessableEntityException;
...
public class ScalePages {
    ...
    public static class Sync extends Base
            implements RequestOperation<ScalePagesRequest, ScalePagesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ScalePagesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ScalePagesRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ScalePagesRequest request) throws Exception {
        ...
        @Override
        public ScalePagesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ScalePagesResponse.Builder resBuilder =
                    ScalePagesResponse
                            .builder()
            ...
            ScalePagesResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ScalePagesBadRequestException out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "413")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ScalePagesRequestEntityTooLargeException out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                        out.withRawResponse(response);
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ScalePagesUnprocessableEntityException out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                        out.withRawResponse(response);
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "500")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ScalePagesInternalServerError out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                        out.withRawResponse(response);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ScalePagesRequest, org.openapis.openapi.models.operations.async.ScalePagesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ScalePagesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ScalePagesRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ScalePagesRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.ScalePagesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.ScalePagesResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.ScalePagesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            org.openapis.openapi.models.operations.async.ScalePagesResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        org.openapis.openapi.models.errors.async.ScalePagesBadRequestException out;
                        try {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "413")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        org.openapis.openapi.models.errors.async.ScalePagesRequestEntityTooLargeException out;
                        try {
                            out = Utils.mapper().readValue(
                                    bodyBytes,
                                    new TypeReference<>() {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        org.openapis.openapi.models.errors.async.ScalePagesUnprocessableEntityException out;
                        try {
                            out = Utils.mapper().readValue(
                                    bodyBytes,
                                    new TypeReference<>() {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "500")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        org.openapis.openapi.models.errors.async.ScalePagesInternalServerError out;
                        try {
                            out = Utils.mapper().readValue(
                                    bodyBytes,
                                    new TypeReference<>() {
