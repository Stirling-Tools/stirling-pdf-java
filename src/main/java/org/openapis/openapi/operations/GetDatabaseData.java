...
public class GetDatabaseData {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<GetDatabaseDataResponse> {
        ...
        @Override
        public GetDatabaseDataResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetDatabaseDataResponse.Builder resBuilder =
                    GetDatabaseDataResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetDatabaseDataResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<org.openapis.openapi.models.operations.async.GetDatabaseDataResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetDatabaseDataResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetDatabaseDataResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetDatabaseDataResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetDatabaseDataResponse res = resBuilder.build();
