...
public class ProcessPdfToRTForTXT {
    ...
    static abstract class Base {
        ...
        <T, U>HttpRequest buildRequest(T request, TypeReference<U> typeReference) throws Exception {
            ...
            req.addHeader("Accept", "text/plain;q=1, application/rtf;q=0")
    ...
    public static class Sync extends Base
            implements RequestOperation<PdfToTextOrRTFRequest, ProcessPdfToRTForTXTResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PdfToTextOrRTFRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<PdfToTextOrRTFRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PdfToTextOrRTFRequest request) throws Exception {
        ...
        @Override
        public ProcessPdfToRTForTXTResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ProcessPdfToRTForTXTResponse.Builder resBuilder =
                    ProcessPdfToRTForTXTResponse
                            .builder()
            ...
            ProcessPdfToRTForTXTResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PdfToTextOrRTFRequest, org.openapis.openapi.models.operations.async.ProcessPdfToRTForTXTResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PdfToTextOrRTFRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<PdfToTextOrRTFRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PdfToTextOrRTFRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.ProcessPdfToRTForTXTResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.ProcessPdfToRTForTXTResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.ProcessPdfToRTForTXTResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            org.openapis.openapi.models.operations.async.ProcessPdfToRTForTXTResponse res = resBuilder.build();
