...
public class ProcessPdfToPresentation {
    ...
    static abstract class Base {
        ...
        <T, U>HttpRequest buildRequest(T request, TypeReference<U> typeReference) throws Exception {
            ...
            req.addHeader("Accept", "application/vnd.openxmlformats-officedocument.presentationml.presentation")
    ...
    public static class Sync extends Base
            implements RequestOperation<PdfToPresentationRequest, ProcessPdfToPresentationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PdfToPresentationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<PdfToPresentationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PdfToPresentationRequest request) throws Exception {
        ...
        @Override
        public ProcessPdfToPresentationResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ProcessPdfToPresentationResponse.Builder resBuilder =
                    ProcessPdfToPresentationResponse
                            .builder()
            ...
            ProcessPdfToPresentationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PdfToPresentationRequest, org.openapis.openapi.models.operations.async.ProcessPdfToPresentationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PdfToPresentationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<PdfToPresentationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PdfToPresentationRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.ProcessPdfToPresentationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.ProcessPdfToPresentationResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.ProcessPdfToPresentationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            org.openapis.openapi.models.operations.async.ProcessPdfToPresentationResponse res = resBuilder.build();
