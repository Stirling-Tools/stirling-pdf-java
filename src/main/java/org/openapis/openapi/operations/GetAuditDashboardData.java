...
public class GetAuditDashboardData {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<GetAuditDashboardDataResponse> {
        ...
        @Override
        public GetAuditDashboardDataResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAuditDashboardDataResponse.Builder resBuilder =
                    GetAuditDashboardDataResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetAuditDashboardDataResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<org.openapis.openapi.models.operations.async.GetAuditDashboardDataResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetAuditDashboardDataResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetAuditDashboardDataResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetAuditDashboardDataResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetAuditDashboardDataResponse res = resBuilder.build();
