...
import org.openapis.openapi.models.errors.AddPageNumbersBadRequestException;
import org.openapis.openapi.models.errors.AddPageNumbersInternalServerError;
import org.openapis.openapi.models.errors.AddPageNumbersRequestEntityTooLargeException;
import org.openapis.openapi.models.errors.AddPageNumbersUnprocessableEntityException;
...
public class AddPageNumbers {
    ...
    public static class Sync extends Base
            implements RequestOperation<AddPageNumbersRequest, AddPageNumbersResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(AddPageNumbersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<AddPageNumbersRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddPageNumbersRequest request) throws Exception {
        ...
        @Override
        public AddPageNumbersResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AddPageNumbersResponse.Builder resBuilder =
            ...
            AddPageNumbersResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AddPageNumbersBadRequestException out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "413")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AddPageNumbersRequestEntityTooLargeException out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                        out.withRawResponse(response);
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AddPageNumbersUnprocessableEntityException out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                        out.withRawResponse(response);
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "500")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AddPageNumbersInternalServerError out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                        out.withRawResponse(response);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AddPageNumbersRequest, org.openapis.openapi.models.operations.async.AddPageNumbersResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(AddPageNumbersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<AddPageNumbersRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AddPageNumbersRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.AddPageNumbersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.AddPageNumbersResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.AddPageNumbersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            org.openapis.openapi.models.operations.async.AddPageNumbersResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        org.openapis.openapi.models.errors.async.AddPageNumbersBadRequestException out;
                        try {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "413")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        org.openapis.openapi.models.errors.async.AddPageNumbersRequestEntityTooLargeException out;
                        try {
                            out = Utils.mapper().readValue(
                                    bodyBytes,
                                    new TypeReference<>() {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        org.openapis.openapi.models.errors.async.AddPageNumbersUnprocessableEntityException out;
                        try {
                            out = Utils.mapper().readValue(
                                    bodyBytes,
                                    new TypeReference<>() {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "500")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        org.openapis.openapi.models.errors.async.AddPageNumbersInternalServerError out;
                        try {
                            out = Utils.mapper().readValue(
                                    bodyBytes,
                                    new TypeReference<>() {
