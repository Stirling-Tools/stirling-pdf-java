...
public class GetAccountData {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<GetAccountDataResponse> {
        ...
        @Override
        public GetAccountDataResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAccountDataResponse.Builder resBuilder =
            ...
            GetAccountDataResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<org.openapis.openapi.models.operations.async.GetAccountDataResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetAccountDataResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetAccountDataResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetAccountDataResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetAccountDataResponse res = resBuilder.build();
