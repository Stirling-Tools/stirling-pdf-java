...
import org.openapis.openapi.models.errors.OptimizePdfBadRequestException;
import org.openapis.openapi.models.errors.OptimizePdfInternalServerError;
import org.openapis.openapi.models.errors.OptimizePdfRequestEntityTooLargeException;
import org.openapis.openapi.models.errors.OptimizePdfUnprocessableEntityException;
...
public class OptimizePdf {
    ...
    public static class Sync extends Base
            implements RequestOperation<OptimizePdfRequest, OptimizePdfResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(OptimizePdfRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<OptimizePdfRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(OptimizePdfRequest request) throws Exception {
        ...
        @Override
        public OptimizePdfResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            OptimizePdfResponse.Builder resBuilder =
                    OptimizePdfResponse
                            .builder()
            ...
            OptimizePdfResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    OptimizePdfBadRequestException out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "413")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    OptimizePdfRequestEntityTooLargeException out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                        out.withRawResponse(response);
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    OptimizePdfUnprocessableEntityException out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                        out.withRawResponse(response);
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "500")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    OptimizePdfInternalServerError out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                        out.withRawResponse(response);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<OptimizePdfRequest, org.openapis.openapi.models.operations.async.OptimizePdfResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(OptimizePdfRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<OptimizePdfRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(OptimizePdfRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.OptimizePdfResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.OptimizePdfResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.OptimizePdfResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            org.openapis.openapi.models.operations.async.OptimizePdfResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        org.openapis.openapi.models.errors.async.OptimizePdfBadRequestException out;
                        try {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "413")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        org.openapis.openapi.models.errors.async.OptimizePdfRequestEntityTooLargeException out;
                        try {
                            out = Utils.mapper().readValue(
                                    bodyBytes,
                                    new TypeReference<>() {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        org.openapis.openapi.models.errors.async.OptimizePdfUnprocessableEntityException out;
                        try {
                            out = Utils.mapper().readValue(
                                    bodyBytes,
                                    new TypeReference<>() {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "500")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        org.openapis.openapi.models.errors.async.OptimizePdfInternalServerError out;
                        try {
                            out = Utils.mapper().readValue(
                                    bodyBytes,
                                    new TypeReference<>() {
