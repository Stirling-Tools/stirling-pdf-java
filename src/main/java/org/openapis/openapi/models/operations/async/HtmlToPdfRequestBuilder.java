...
public class HtmlToPdfRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private HTMLToPdfRequest request;

    public HtmlToPdfRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
    }

    public HtmlToPdfRequestBuilder request(@Nullable HTMLToPdfRequest request) {
        this.request = request;
        return this;
    }

    private HTMLToPdfRequest _buildRequest() {
        return this.request;
    }
    
    public HtmlToPdfRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<HtmlToPdfResponse> call() {
