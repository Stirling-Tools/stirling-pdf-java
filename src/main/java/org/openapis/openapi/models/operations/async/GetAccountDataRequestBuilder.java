...
public class GetAccountDataRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();

    public GetAccountDataRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
    }

    
    public GetAccountDataRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<GetAccountDataResponse> call() {
