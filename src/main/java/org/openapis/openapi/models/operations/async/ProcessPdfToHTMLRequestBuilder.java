...
public class ProcessPdfToHTMLRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private PDFFile request;

    public ProcessPdfToHTMLRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
    }

    public ProcessPdfToHTMLRequestBuilder request(@Nullable PDFFile request) {
    ...
    public ProcessPdfToHTMLRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<ProcessPdfToHTMLResponse> call() {
