...
public class ProcessPdfToXMLRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private PDFFile request;

    public ProcessPdfToXMLRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
    }

    public ProcessPdfToXMLRequestBuilder request(@Nullable PDFFile request) {
    ...
    public ProcessPdfToXMLRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<ProcessPdfToXMLResponse> call() {
