...
public class GetFontInfoRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private PDFFile request;

    public GetFontInfoRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
    }

    public GetFontInfoRequestBuilder request(@Nullable PDFFile request) {
    ...
    public GetFontInfoRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<GetFontInfoResponse> call() {
