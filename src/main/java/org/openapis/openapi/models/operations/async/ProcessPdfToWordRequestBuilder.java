...
public class ProcessPdfToWordRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private PdfToWordRequest request;

    public ProcessPdfToWordRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
    }

    public ProcessPdfToWordRequestBuilder request(@Nullable PdfToWordRequest request) {
        this.request = request;
        return this;
    }

    private PdfToWordRequest _buildRequest() {
        return this.request;
    }
    
    public ProcessPdfToWordRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<ProcessPdfToWordResponse> call() {
