...
public class MetadataResponse implements AsyncResponse {
    /**
     ...
     * HTTP response content type for this operation
     */
    public MetadataResponse withContentType(@Nonnull String contentType) {
     ...
     * HTTP response status code for this operation
     */
    public MetadataResponse withStatusCode(int statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public MetadataResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
     ...
     * PDF processed successfully
     */
    public MetadataResponse withResponseStream(@Nullable Blob responseStream) {
        this.responseStream = responseStream;
        return this;
    }
