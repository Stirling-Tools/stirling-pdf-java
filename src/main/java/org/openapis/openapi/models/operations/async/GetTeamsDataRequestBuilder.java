...
public class GetTeamsDataRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();

    public GetTeamsDataRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
    }

    
    public GetTeamsDataRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<GetTeamsDataResponse> call() {
