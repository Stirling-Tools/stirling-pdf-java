...
public class PdfToCsvRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private PDFWithPageNums request;

    public PdfToCsvRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
    }

    public PdfToCsvRequestBuilder request(@Nullable PDFWithPageNums request) {
    ...
    public PdfToCsvRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<PdfToCsvResponse> call() {
