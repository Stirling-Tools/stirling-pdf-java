...
public class GetBasicInfoRequestBuilder {
    ...
    public GetBasicInfoRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
    }

    public GetBasicInfoRequestBuilder request(@Nullable PDFFile request) {
    ...
    public GetBasicInfoRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<GetBasicInfoResponse> call() {
