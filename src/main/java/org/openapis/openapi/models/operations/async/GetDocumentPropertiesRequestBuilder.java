...
public class GetDocumentPropertiesRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private PDFFile request;

    public GetDocumentPropertiesRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
    }

    public GetDocumentPropertiesRequestBuilder request(@Nullable PDFFile request) {
    ...
    public GetDocumentPropertiesRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<GetDocumentPropertiesResponse> call() {
