...
public class GetSecurityInfoRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private PDFFile request;

    public GetSecurityInfoRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
    }

    public GetSecurityInfoRequestBuilder request(@Nullable PDFFile request) {
    ...
    public GetSecurityInfoRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<GetSecurityInfoResponse> call() {
