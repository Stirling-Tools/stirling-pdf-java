...
public class GetFormFieldsRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private PDFFile request;

    public GetFormFieldsRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
    }

    public GetFormFieldsRequestBuilder request(@Nullable PDFFile request) {
    ...
    public GetFormFieldsRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<GetFormFieldsResponse> call() {
