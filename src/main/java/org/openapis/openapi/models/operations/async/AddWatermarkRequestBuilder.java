...
public class AddWatermarkRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private AddWatermarkRequest request;

    public AddWatermarkRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
    }

    public AddWatermarkRequestBuilder request(@Nullable AddWatermarkRequest request) {
        this.request = request;
        return this;
    }

    private AddWatermarkRequest _buildRequest() {
        return this.request;
    }
    
    public AddWatermarkRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<AddWatermarkResponse> call() {
