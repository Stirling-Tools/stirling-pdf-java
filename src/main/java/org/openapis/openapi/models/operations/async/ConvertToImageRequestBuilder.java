...
public class ConvertToImageRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private ConvertToImageRequest request;

    public ConvertToImageRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
    }

    public ConvertToImageRequestBuilder request(@Nullable ConvertToImageRequest request) {
        this.request = request;
        return this;
    }

    private ConvertToImageRequest _buildRequest() {
        return this.request;
    }
    
    public ConvertToImageRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<ConvertToImageResponse> call() {
