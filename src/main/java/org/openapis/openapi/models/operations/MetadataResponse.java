...
public class MetadataResponse implements Response {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public MetadataResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
     ...
     * PDF processed successfully
     */
    public MetadataResponse withResponseStream(@Nullable InputStream responseStream) {
        this.responseStream = responseStream;
        return this;
    }
