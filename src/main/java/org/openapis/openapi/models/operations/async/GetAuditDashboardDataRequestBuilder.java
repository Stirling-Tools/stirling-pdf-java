...
public class GetAuditDashboardDataRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();

    public GetAuditDashboardDataRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
    }

    
    public GetAuditDashboardDataRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<GetAuditDashboardDataResponse> call() {
