...
public class GetPageCountRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private PDFFile request;

    public GetPageCountRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
    }

    public GetPageCountRequestBuilder request(@Nullable PDFFile request) {
    ...
    public GetPageCountRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<GetPageCountResponse> call() {
