...
public class GetPageDimensionsRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private PDFFile request;

    public GetPageDimensionsRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
    }

    public GetPageDimensionsRequestBuilder request(@Nullable PDFFile request) {
    ...
    public GetPageDimensionsRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<GetPageDimensionsResponse> call() {
