...
public class UrlToPdfRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private UrlToPdfRequest request;

    public UrlToPdfRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
    }

    public UrlToPdfRequestBuilder request(@Nullable UrlToPdfRequest request) {
        this.request = request;
        return this;
    }

    private UrlToPdfRequest _buildRequest() {
        return this.request;
    }
    
    public UrlToPdfRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<UrlToPdfResponse> call() {
