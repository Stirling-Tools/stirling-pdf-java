...
public class GetAdminSettingsDataRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();

    public GetAdminSettingsDataRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
    }

    
    public GetAdminSettingsDataRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<GetAdminSettingsDataResponse> call() {
