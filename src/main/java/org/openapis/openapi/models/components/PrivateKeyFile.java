...
public class PrivateKeyFile {
    ...
    public PrivateKeyFile withFileName(@Nonnull String fileName) {
        this.fileName = Utils.checkNotNull(fileName, "fileName");
        return this;
    }


    public PrivateKeyFile withContent(@Nonnull byte[] content) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PrivateKeyFile other = (PrivateKeyFile) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PrivateKeyFile.class,
                "fileName", fileName,
                "content", content);
    }
