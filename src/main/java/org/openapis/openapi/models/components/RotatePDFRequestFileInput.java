...
public class RotatePDFRequestFileInput {
    ...
    @JsonCreator
    public RotatePDFRequestFileInput(
    ...
    public RotatePDFRequestFileInput withFileName(@Nonnull String fileName) {
        this.fileName = Utils.checkNotNull(fileName, "fileName");
        return this;
    }


    public RotatePDFRequestFileInput withContent(@Nonnull byte[] content) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        RotatePDFRequestFileInput other = (RotatePDFRequestFileInput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(RotatePDFRequestFileInput.class,
                "fileName", fileName,
                "content", content);
    }
    ...
    public final static class Builder {
        ...
        public RotatePDFRequestFileInput build() {
            return new RotatePDFRequestFileInput(
                fileName, content);
        }
