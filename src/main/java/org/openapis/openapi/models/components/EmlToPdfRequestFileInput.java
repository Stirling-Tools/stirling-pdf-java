...
public class EmlToPdfRequestFileInput {
    ...
    @JsonCreator
    public EmlToPdfRequestFileInput(
    ...
    public EmlToPdfRequestFileInput withFileName(@Nonnull String fileName) {
        this.fileName = Utils.checkNotNull(fileName, "fileName");
        return this;
    }


    public EmlToPdfRequestFileInput withContent(@Nonnull byte[] content) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        EmlToPdfRequestFileInput other = (EmlToPdfRequestFileInput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(EmlToPdfRequestFileInput.class,
                "fileName", fileName,
                "content", content);
    }
    ...
    public final static class Builder {
        ...
        public EmlToPdfRequestFileInput build() {
            return new EmlToPdfRequestFileInput(
                fileName, content);
        }
