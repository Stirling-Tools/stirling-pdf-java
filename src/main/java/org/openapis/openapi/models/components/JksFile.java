...
public class JksFile {
    ...
    public JksFile withFileName(@Nonnull String fileName) {
        this.fileName = Utils.checkNotNull(fileName, "fileName");
        return this;
    }


    public JksFile withContent(@Nonnull byte[] content) {
    ...
    public String toString() {
        return Utils.toString(JksFile.class,
                "fileName", fileName,
                "content", content);
    }
