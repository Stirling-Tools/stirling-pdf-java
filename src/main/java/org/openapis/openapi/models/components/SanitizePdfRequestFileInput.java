...
public class SanitizePdfRequestFileInput {
    ...
    @JsonCreator
    public SanitizePdfRequestFileInput(
    ...
    public SanitizePdfRequestFileInput withFileName(@Nonnull String fileName) {
        this.fileName = Utils.checkNotNull(fileName, "fileName");
        return this;
    }


    public SanitizePdfRequestFileInput withContent(@Nonnull byte[] content) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SanitizePdfRequestFileInput other = (SanitizePdfRequestFileInput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SanitizePdfRequestFileInput.class,
                "fileName", fileName,
                "content", content);
    }
    ...
    public final static class Builder {
        ...
        public SanitizePdfRequestFileInput build() {
            return new SanitizePdfRequestFileInput(
                fileName, content);
        }
