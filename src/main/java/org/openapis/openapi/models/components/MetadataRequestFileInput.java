...
public class MetadataRequestFileInput {
    ...
    @JsonCreator
    public MetadataRequestFileInput(
    ...
    public MetadataRequestFileInput withFileName(@Nonnull String fileName) {
        this.fileName = Utils.checkNotNull(fileName, "fileName");
        return this;
    }


    public MetadataRequestFileInput withContent(@Nonnull byte[] content) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        MetadataRequestFileInput other = (MetadataRequestFileInput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(MetadataRequestFileInput.class,
                "fileName", fileName,
                "content", content);
    }
    ...
    public final static class Builder {
        ...
        public MetadataRequestFileInput build() {
            return new MetadataRequestFileInput(
                fileName, content);
        }
