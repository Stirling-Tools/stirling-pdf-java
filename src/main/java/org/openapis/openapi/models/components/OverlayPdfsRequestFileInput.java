...
public class OverlayPdfsRequestFileInput {
    ...
    @JsonCreator
    public OverlayPdfsRequestFileInput(
    ...
    public OverlayPdfsRequestFileInput withFileName(@Nonnull String fileName) {
        this.fileName = Utils.checkNotNull(fileName, "fileName");
        return this;
    }


    public OverlayPdfsRequestFileInput withContent(@Nonnull byte[] content) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        OverlayPdfsRequestFileInput other = (OverlayPdfsRequestFileInput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(OverlayPdfsRequestFileInput.class,
                "fileName", fileName,
                "content", content);
    }
    ...
    public final static class Builder {
        ...
        public OverlayPdfsRequestFileInput build() {
            return new OverlayPdfsRequestFileInput(
                fileName, content);
        }
