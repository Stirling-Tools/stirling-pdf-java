...
public class PageSizeRequestFileInput {
    ...
    @JsonCreator
    public PageSizeRequestFileInput(
    ...
    public PageSizeRequestFileInput withFileName(@Nonnull String fileName) {
        this.fileName = Utils.checkNotNull(fileName, "fileName");
        return this;
    }


    public PageSizeRequestFileInput withContent(@Nonnull byte[] content) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PageSizeRequestFileInput other = (PageSizeRequestFileInput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PageSizeRequestFileInput.class,
                "fileName", fileName,
                "content", content);
    }
    ...
    public final static class Builder {
        ...
        public PageSizeRequestFileInput build() {
            return new PageSizeRequestFileInput(
                fileName, content);
        }
