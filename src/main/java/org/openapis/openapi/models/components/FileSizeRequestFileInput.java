...
public class FileSizeRequestFileInput {
    ...
    @JsonCreator
    public FileSizeRequestFileInput(
    ...
    public FileSizeRequestFileInput withFileName(@Nonnull String fileName) {
        this.fileName = Utils.checkNotNull(fileName, "fileName");
        return this;
    }


    public FileSizeRequestFileInput withContent(@Nonnull byte[] content) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        FileSizeRequestFileInput other = (FileSizeRequestFileInput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(FileSizeRequestFileInput.class,
                "fileName", fileName,
                "content", content);
    }
    ...
    public final static class Builder {
        ...
        public FileSizeRequestFileInput build() {
            return new FileSizeRequestFileInput(
                fileName, content);
        }
