...
public class FlattenRequestFileInput {
    ...
    @JsonCreator
    public FlattenRequestFileInput(
    ...
    public FlattenRequestFileInput withFileName(@Nonnull String fileName) {
        this.fileName = Utils.checkNotNull(fileName, "fileName");
        return this;
    }


    public FlattenRequestFileInput withContent(@Nonnull byte[] content) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        FlattenRequestFileInput other = (FlattenRequestFileInput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(FlattenRequestFileInput.class,
                "fileName", fileName,
                "content", content);
    }
    ...
    public final static class Builder {
        ...
        public FlattenRequestFileInput build() {
            return new FlattenRequestFileInput(
                fileName, content);
        }
