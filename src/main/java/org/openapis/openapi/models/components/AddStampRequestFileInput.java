...
public class AddStampRequestFileInput {
    ...
    @JsonCreator
    public AddStampRequestFileInput(
    ...
    public AddStampRequestFileInput withFileName(@Nonnull String fileName) {
        this.fileName = Utils.checkNotNull(fileName, "fileName");
        return this;
    }


    public AddStampRequestFileInput withContent(@Nonnull byte[] content) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AddStampRequestFileInput other = (AddStampRequestFileInput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AddStampRequestFileInput.class,
                "fileName", fileName,
                "content", content);
    }
    ...
    public final static class Builder {
        ...
        public AddStampRequestFileInput build() {
            return new AddStampRequestFileInput(
                fileName, content);
        }
