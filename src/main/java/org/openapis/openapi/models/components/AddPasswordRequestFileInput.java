...
public class AddPasswordRequestFileInput {
    ...
    @JsonCreator
    public AddPasswordRequestFileInput(
    ...
    public AddPasswordRequestFileInput withFileName(@Nonnull String fileName) {
        this.fileName = Utils.checkNotNull(fileName, "fileName");
        return this;
    }


    public AddPasswordRequestFileInput withContent(@Nonnull byte[] content) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AddPasswordRequestFileInput other = (AddPasswordRequestFileInput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AddPasswordRequestFileInput.class,
                "fileName", fileName,
                "content", content);
    }
    ...
    public final static class Builder {
        ...
        public AddPasswordRequestFileInput build() {
            return new AddPasswordRequestFileInput(
                fileName, content);
        }
