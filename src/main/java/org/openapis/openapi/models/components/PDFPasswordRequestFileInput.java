...
public class PDFPasswordRequestFileInput {
    ...
    @JsonCreator
    public PDFPasswordRequestFileInput(
    ...
    public PDFPasswordRequestFileInput withFileName(@Nonnull String fileName) {
        this.fileName = Utils.checkNotNull(fileName, "fileName");
        return this;
    }


    public PDFPasswordRequestFileInput withContent(@Nonnull byte[] content) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PDFPasswordRequestFileInput other = (PDFPasswordRequestFileInput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PDFPasswordRequestFileInput.class,
                "fileName", fileName,
                "content", content);
    }
    ...
    public final static class Builder {
        ...
        public PDFPasswordRequestFileInput build() {
            return new PDFPasswordRequestFileInput(
                fileName, content);
        }
