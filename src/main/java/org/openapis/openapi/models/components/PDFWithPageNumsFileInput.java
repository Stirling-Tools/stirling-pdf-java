...
public class PDFWithPageNumsFileInput {
    ...
    @JsonCreator
    public PDFWithPageNumsFileInput(
    ...
    public PDFWithPageNumsFileInput withFileName(@Nonnull String fileName) {
        this.fileName = Utils.checkNotNull(fileName, "fileName");
        return this;
    }


    public PDFWithPageNumsFileInput withContent(@Nonnull byte[] content) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PDFWithPageNumsFileInput other = (PDFWithPageNumsFileInput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PDFWithPageNumsFileInput.class,
                "fileName", fileName,
                "content", content);
    }
    ...
    public final static class Builder {
        ...
        public PDFWithPageNumsFileInput build() {
            return new PDFWithPageNumsFileInput(
                fileName, content);
        }
