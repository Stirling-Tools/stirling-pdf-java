...
public class OverlayFile {
    ...
    public OverlayFile withFileName(@Nonnull String fileName) {
        this.fileName = Utils.checkNotNull(fileName, "fileName");
        return this;
    }


    public OverlayFile withContent(@Nonnull byte[] content) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        OverlayFile other = (OverlayFile) o;
        return 
    ...
    public String toString() {
        return Utils.toString(OverlayFile.class,
                "fileName", fileName,
                "content", content);
    }
