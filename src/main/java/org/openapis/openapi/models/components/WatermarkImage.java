...
public class WatermarkImage {
    ...
    public WatermarkImage withFileName(@Nonnull String fileName) {
        this.fileName = Utils.checkNotNull(fileName, "fileName");
        return this;
    }


    public WatermarkImage withContent(@Nonnull byte[] content) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        WatermarkImage other = (WatermarkImage) o;
        return 
    ...
    public String toString() {
        return Utils.toString(WatermarkImage.class,
                "fileName", fileName,
                "content", content);
    }
