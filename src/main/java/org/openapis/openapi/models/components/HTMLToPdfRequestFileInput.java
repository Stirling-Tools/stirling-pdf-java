...
public class HTMLToPdfRequestFileInput {
    ...
    @JsonCreator
    public HTMLToPdfRequestFileInput(
    ...
    public HTMLToPdfRequestFileInput withFileName(@Nonnull String fileName) {
        this.fileName = Utils.checkNotNull(fileName, "fileName");
        return this;
    }


    public HTMLToPdfRequestFileInput withContent(@Nonnull byte[] content) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HTMLToPdfRequestFileInput other = (HTMLToPdfRequestFileInput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(HTMLToPdfRequestFileInput.class,
                "fileName", fileName,
                "content", content);
    }
    ...
    public final static class Builder {
        ...
        public HTMLToPdfRequestFileInput build() {
            return new HTMLToPdfRequestFileInput(
                fileName, content);
        }
