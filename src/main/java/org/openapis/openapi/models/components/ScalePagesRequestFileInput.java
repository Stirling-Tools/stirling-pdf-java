...
public class ScalePagesRequestFileInput {
    ...
    @JsonCreator
    public ScalePagesRequestFileInput(
    ...
    public ScalePagesRequestFileInput withFileName(@Nonnull String fileName) {
        this.fileName = Utils.checkNotNull(fileName, "fileName");
        return this;
    }


    public ScalePagesRequestFileInput withContent(@Nonnull byte[] content) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ScalePagesRequestFileInput other = (ScalePagesRequestFileInput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ScalePagesRequestFileInput.class,
                "fileName", fileName,
                "content", content);
    }
    ...
    public final static class Builder {
        ...
        public ScalePagesRequestFileInput build() {
            return new ScalePagesRequestFileInput(
                fileName, content);
        }
