...
public class MergePdfsRequestFileInput {
    ...
    @JsonCreator
    public MergePdfsRequestFileInput(
    ...
    public MergePdfsRequestFileInput withFileName(@Nonnull String fileName) {
        this.fileName = Utils.checkNotNull(fileName, "fileName");
        return this;
    }


    public MergePdfsRequestFileInput withContent(@Nonnull byte[] content) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        MergePdfsRequestFileInput other = (MergePdfsRequestFileInput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(MergePdfsRequestFileInput.class,
                "fileName", fileName,
                "content", content);
    }
    ...
    public final static class Builder {
        ...
        public MergePdfsRequestFileInput build() {
            return new MergePdfsRequestFileInput(
                fileName, content);
        }
