...
public class CropPdfFormFileInput {
    ...
    public CropPdfFormFileInput withFileName(@Nonnull String fileName) {
        this.fileName = Utils.checkNotNull(fileName, "fileName");
        return this;
    }


    public CropPdfFormFileInput withContent(@Nonnull byte[] content) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CropPdfFormFileInput other = (CropPdfFormFileInput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CropPdfFormFileInput.class,
                "fileName", fileName,
                "content", content);
    }
    ...
    public final static class Builder {
        ...
        public CropPdfFormFileInput build() {
            return new CropPdfFormFileInput(
                fileName, content);
        }
