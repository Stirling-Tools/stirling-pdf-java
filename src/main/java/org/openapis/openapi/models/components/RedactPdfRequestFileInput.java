...
public class RedactPdfRequestFileInput {
    ...
    @JsonCreator
    public RedactPdfRequestFileInput(
    ...
    public RedactPdfRequestFileInput withFileName(@Nonnull String fileName) {
        this.fileName = Utils.checkNotNull(fileName, "fileName");
        return this;
    }


    public RedactPdfRequestFileInput withContent(@Nonnull byte[] content) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        RedactPdfRequestFileInput other = (RedactPdfRequestFileInput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(RedactPdfRequestFileInput.class,
                "fileName", fileName,
                "content", content);
    }
    ...
    public final static class Builder {
        ...
        public RedactPdfRequestFileInput build() {
            return new RedactPdfRequestFileInput(
                fileName, content);
        }
