...
public class PDFFileFileInput {
    ...
    public PDFFileFileInput withFileName(@Nonnull String fileName) {
        this.fileName = Utils.checkNotNull(fileName, "fileName");
        return this;
    }


    public PDFFileFileInput withContent(@Nonnull byte[] content) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PDFFileFileInput other = (PDFFileFileInput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PDFFileFileInput.class,
                "fileName", fileName,
                "content", content);
    }
    ...
    public final static class Builder {
        ...
        public PDFFileFileInput build() {
            return new PDFFileFileInput(
                fileName, content);
        }
