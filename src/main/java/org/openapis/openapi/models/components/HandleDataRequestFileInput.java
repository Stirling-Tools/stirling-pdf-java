...
public class HandleDataRequestFileInput {
    ...
    @JsonCreator
    public HandleDataRequestFileInput(
    ...
    public HandleDataRequestFileInput withFileName(@Nonnull String fileName) {
        this.fileName = Utils.checkNotNull(fileName, "fileName");
        return this;
    }


    public HandleDataRequestFileInput withContent(@Nonnull byte[] content) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HandleDataRequestFileInput other = (HandleDataRequestFileInput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(HandleDataRequestFileInput.class,
                "fileName", fileName,
                "content", content);
    }
    ...
    public final static class Builder {
        ...
        public HandleDataRequestFileInput build() {
            return new HandleDataRequestFileInput(
                fileName, content);
        }
