...
public class PdfToWordRequestFileInput {
    ...
    @JsonCreator
    public PdfToWordRequestFileInput(
    ...
    public PdfToWordRequestFileInput withFileName(@Nonnull String fileName) {
        this.fileName = Utils.checkNotNull(fileName, "fileName");
        return this;
    }


    public PdfToWordRequestFileInput withContent(@Nonnull byte[] content) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PdfToWordRequestFileInput other = (PdfToWordRequestFileInput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PdfToWordRequestFileInput.class,
                "fileName", fileName,
                "content", content);
    }
    ...
    public final static class Builder {
        ...
        public PdfToWordRequestFileInput build() {
            return new PdfToWordRequestFileInput(
                fileName, content);
        }
