...
public class GeneralFileFileInput {
    ...
    public GeneralFileFileInput withFileName(@Nonnull String fileName) {
        this.fileName = Utils.checkNotNull(fileName, "fileName");
        return this;
    }


    public GeneralFileFileInput withContent(@Nonnull byte[] content) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GeneralFileFileInput other = (GeneralFileFileInput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GeneralFileFileInput.class,
                "fileName", fileName,
                "content", content);
    }
    ...
    public final static class Builder {
        ...
        public GeneralFileFileInput build() {
            return new GeneralFileFileInput(
                fileName, content);
        }
