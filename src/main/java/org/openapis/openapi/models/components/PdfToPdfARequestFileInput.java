...
public class PdfToPdfARequestFileInput {
    ...
    @JsonCreator
    public PdfToPdfARequestFileInput(
    ...
    public PdfToPdfARequestFileInput withFileName(@Nonnull String fileName) {
        this.fileName = Utils.checkNotNull(fileName, "fileName");
        return this;
    }


    public PdfToPdfARequestFileInput withContent(@Nonnull byte[] content) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PdfToPdfARequestFileInput other = (PdfToPdfARequestFileInput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PdfToPdfARequestFileInput.class,
                "fileName", fileName,
                "content", content);
    }
    ...
    public final static class Builder {
        ...
        public PdfToPdfARequestFileInput build() {
            return new PdfToPdfARequestFileInput(
                fileName, content);
        }
