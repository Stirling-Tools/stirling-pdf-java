...
public class P12File {
    ...
    public P12File withFileName(@Nonnull String fileName) {
        this.fileName = Utils.checkNotNull(fileName, "fileName");
        return this;
    }


    public P12File withContent(@Nonnull byte[] content) {
    ...
    public String toString() {
        return Utils.toString(P12File.class,
                "fileName", fileName,
                "content", content);
    }
