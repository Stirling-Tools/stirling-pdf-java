...
public class OptimizePdfRequestFileInput {
    ...
    @JsonCreator
    public OptimizePdfRequestFileInput(
    ...
    public OptimizePdfRequestFileInput withFileName(@Nonnull String fileName) {
        this.fileName = Utils.checkNotNull(fileName, "fileName");
        return this;
    }


    public OptimizePdfRequestFileInput withContent(@Nonnull byte[] content) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        OptimizePdfRequestFileInput other = (OptimizePdfRequestFileInput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(OptimizePdfRequestFileInput.class,
                "fileName", fileName,
                "content", content);
    }
    ...
    public final static class Builder {
        ...
        public OptimizePdfRequestFileInput build() {
            return new OptimizePdfRequestFileInput(
                fileName, content);
        }
