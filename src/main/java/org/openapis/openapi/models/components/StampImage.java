...
public class StampImage {
    ...
    public StampImage withFileName(@Nonnull String fileName) {
        this.fileName = Utils.checkNotNull(fileName, "fileName");
        return this;
    }


    public StampImage withContent(@Nonnull byte[] content) {
    ...
    public String toString() {
        return Utils.toString(StampImage.class,
                "fileName", fileName,
                "content", content);
    }
    ...
    public final static class Builder {
        ...
        public StampImage build() {
            return new StampImage(
                fileName, content);
        }
